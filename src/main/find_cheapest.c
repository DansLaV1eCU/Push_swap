...
int	find_biggest_lower(t_stack *b, int value)
{
	...
	while (temp)
	{
		if (temp->value < value && (!biggest_lower_node
				|| temp->value > biggest_lower_node->value))
...
int	find_lowest_bigger(t_stack *a, int value)
{
	...
	while (temp)
	{
		if (temp->value > value && (!lowest_bigger_node
				|| temp->value < lowest_bigger_node->value))
